...
North Echo is a hands-on, replayable Linux containment course for learning agent security by building, observing, breaking, fixing, and verifying. Modules 01-06 are fully implemented and Linux-validated on Ubuntu 24.04 arm64; Modules 07-12 remain design scaffolds.
...
./lab-start capstone --cold           # concept exists; capstone is not implemented in v0.2
```
